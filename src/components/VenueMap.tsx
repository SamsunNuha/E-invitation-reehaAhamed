...
export const VenueMap: React.FC<VenueMapProps> = ({
  ...
  return (
    <div className="w-full max-w-2xl mx-auto my-16 px-4 space-y-12">
      ...
      <motion.div
        className="p-8 md:p-12 rounded-3xl bg-[#2E050D]/90 border-2 border-[#D4AF37]/60 shadow-2xl backdrop-blur-md flex flex-col items-center text-center relative overflow-hidden"
      ...
      >
        ...
        <h3 className="text-3xl md:text-5xl font-serif font-bold text-[#FCEEAC] mb-4 drop-shadow-md">
          Location
        </h3>

        {/* Golden Heart Map Pin */}
        <div className="w-12 h-12 rounded-full bg-[#D4AF37]/20 border border-[#D4AF37]/60 flex items-center justify-center text-xl mb-3 shadow-md">
          🤎
        </div>

        <h4 className="text-xl md:text-2xl font-serif font-bold text-[#FFF8ED] mb-1">{locationName}</h4>
        <p className="text-xs md:text-sm font-serif text-[#FCEEAC]/90 mb-6">{venueAddress}</p>
